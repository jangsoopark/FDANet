...
parser = argparse.ArgumentParser(description='Levir-CD Change Data Patch Extraction')
parser.add_argument('--dataset-root', type=str,
                    default='/workspace/dataset/Levir-CD/',
                    help='Original dataset root')
parser.add_argument('--experiment-root', type=str,
                    default='/workspace/dataset/Levir-CD-experiment/',
